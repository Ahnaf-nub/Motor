...
Motor::Motor(int mpin_pins[6], bool motor_A_dir, bool motor_B_dir) {
...
void Motor::motor(int speedA, int speedB, bool directionA, bool directionB) {
  if (directionA) {
